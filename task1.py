...
if __name__ == '__main__':
    ...
    audio_book = AudioBook(name="Гарри Поттер и философский камень", author="Джоан Роулинг", duration=8.5)

    print(paper_book)  # Проверяем метод __str__
    print(audio_book)  # Проверяем метод __str__

    print(repr(paper_book))  # Проверяем метод __repr__
    print(repr(audio_book))  # Проверяем метод __repr__